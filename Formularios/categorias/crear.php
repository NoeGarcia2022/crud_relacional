                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDC/insertarDatos.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre de la categoria" required>
                            </div>
                            <div class="mb-3">
                                <label for="nombreP" class="form-label">Estado</label>
                                <input type="text" class="form-control" id="estadoC" name="estadoC" placeholder="Estado categoria" required>
                            </div>
