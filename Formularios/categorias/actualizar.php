                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDC/editarDatos.php" method="post">
                            ...
                            $sql = "SELECT * FROM categorias WHERE idCategoria =" . $_REQUEST['Id'];
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre del producto" value="<?php echo $row['nombreCategoria'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="estadoC" class="form-label">Estado</label>
                                <input type="text" class="form-control" id="estadoC" name="estadoC" placeholder="Nombre del producto" value="<?php echo $row['EstadoCategoria'] ?>">
                            </div>
